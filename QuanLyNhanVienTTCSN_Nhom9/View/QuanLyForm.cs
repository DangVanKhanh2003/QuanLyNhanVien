...
namespace QuanLyNhanVienTTCSN_Nhom9
{
    public partial class QuanLyForm : Form
    {
        ...
        {
            TimKiemNV searchEmpForm = new TimKiemNV();
            searchEmpForm.ShowDialog();
        }

        private void searchSalaryBtn_Click(object sender, EventArgs e)
        {
            TimKiemChuVu searchSalaryForm = new TimKiemChuVu();
            searchSalaryForm.ShowDialog();
        }

        private void searchOnLeaveBtn_Click(object sender, EventArgs e)
        {
            TimKiemNghiPhep searchOnLeaveForm = new TimKiemNghiPhep();
            searchOnLeaveForm.ShowDialog();
        }
    }
}
